				...
				<div class="tab-content" id="switcher-tabContent">
					<div class="tab-pane fade show active" id="switcherPreBuilt" role="tabpanel" aria-labelledby="switcherPreBuilt-tab" tabindex="0">
						<div class="switcher-demo">
							<img src="/assets/images/theme/demo1.webp" alt="">
							<div class="demo-btns">
						...
						<div class="switcher-demo">
							<img src="/assets/images/theme/demo2.webp" alt="">
							<div class="demo-btns">
						...
						<div class="switcher-demo">
							<img src="/assets/images/theme/demo3.webp" alt="">
							<div class="demo-btns">
						...
						<div class="switcher-demo">
							<img src="/assets/images/theme/demo4.webp" alt="">
							<div class="demo-btns">
									...
									<div class="col-lg-6">
										<div class="switcher-theme">
											...
											<label for="switcherThemeLight" class="form-check-label">
												<img src="/assets/images/theme/light.svg" alt="">
									...
									<div class="col-lg-6">
										<div class="switcher-theme">
											...
											<label for="switcherThemeDark" class="form-check-label">
												<img src="/assets/images/theme/dark.svg" alt="">
