    ...
    <div class="container" id="letter">
        ...
        <main>
            ...
            <p>
                ...
                {{ auth()->user()->college ?? 'college name' }}
            </p>

            <p>
                <strong>Subject: Internship Confirmation for {{ auth()->user()->position ?? 'position' }}</strong>
            </p>
            ...
            <p>
                ...
                D/O <strong>{{ auth()->user()->father_name ?? '--' }}</strong>,
                Roll No. <strong>{{ auth()->user()->roll_no ?? '--' }}</strong>,
                currently pursuing
                <strong>{{ auth()->user()->course ?? '--' }}</strong>,
                has taken Enrolled in
                our organization For An Internship Program. The internship will scheduled to
                commence from
                <strong>{{ auth()->user()->date_of_joining ?? '--' }}</strong>.
            </p>
